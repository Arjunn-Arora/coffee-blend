		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				...
		              				<div class="text">
		              					...
		              					<p><a target="_blank" href="products/product-single.php?id=<?php echo $drink->id; ?>" class="btn btn-primary btn-outline-primary">View Product</a></p>
		              				</div>
		              			</div>
		              		</div>
							  <?php endforeach; ?>
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				...
		              				<div class="text">
		              					...
		              					<p><a target="_blank" href="products/product-single.php?id=<?php echo $dessert->id; ?>" class="btn btn-primary btn-outline-primary">View Product</a></p>
		              				</div>
		              			</div>
		              		</div>
							  <?php endforeach; ?>
