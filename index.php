    ...
    <section class="ftco-intro">
    	<div class="container-wrap">
    		<div class="wrap d-md-flex align-items-xl-end">
	    		...
	    		<div class="book p-4">
	    			<h3>Book a Table</h3>
	    			<form action="booking/booking.php" method="POST" class="appointment-form">
	    				<div class="d-md-flex">
					...
					<?php else : ?>
						<div class="form-group ml-md-4">
		              <a href="<?php echo APPURL; ?>/auth/login.php" class="btn btn-white py-3 px-4">Login To Book a Table </a>
		            </div>
					<?php endif; ?>
	    				</div>
	    			</form>
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					...
    					<div class="text text-center pt-4">
    						<h3><a href="<?php echo APPURL; ?>/products/product-single.php?id=<?php echo $products->id; ?>"><?php echo $products->name; ?></a></h3>
    						<p><?php echo $products->description; ?></p>
    						<p class="price"><span>$<?php echo $products->price; ?></span></p>
    						<p><a target="_blank" href="products/product-single.php?id=<?php echo $products->id; ?>" class="btn btn-primary btn-outline-primary">View Product</a></p>
    					</div>
    				</div>
        	</div><!--
        	<div class="col-md-3">
